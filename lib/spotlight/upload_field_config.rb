...
module Spotlight
  ...
  class UploadFieldConfig
    attr_reader :blacklight_options, :field_name, :form_field_type, :additional_solr_fields
    def initialize(blacklight_options: {}, field_name:, form_field_type: :text_field, label: nil, additional_solr_fields: [])
      @blacklight_options = blacklight_options
      @field_name = field_name
      @form_field_type = form_field_type
      @additional_solr_fields = additional_solr_fields
