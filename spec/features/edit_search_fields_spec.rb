  ...
  describe 'edit' do
    ...
    describe 'sort' do
      ...
      it 'updates sort options' do
        ...
        find_by_id('blacklight_configuration_sort_fields_type_weight', visible: false).set('100')
        ...
        expect(find_by_id('blacklight_configuration_sort_fields_identifier_enabled')).not_to be_checked
