  ...
  describe '#to_solr' do
    ...
    context 'with an uploaded item' do
      ...
      let(:uploaded_field_config) do
        Spotlight::UploadFieldConfig.new(field_name: 'some_configured_field', additional_solr_fields: ['an_additional_field'])
      end

      its(:to_solr) { should include 'some_configured_field' => 'some value', 'an_additional_field' => 'some value' }
    end
  end
end
