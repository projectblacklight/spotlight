...
describe Spotlight::Resources::Csv, type: :model do
  ...
  describe '#to_solr' do
    ...
    it 'maps csv headers to solr fields' do
  ...
  describe 'persisting exhibit-specific fields into sidecar rows' do
    ...
    it 'creates sidecar files for custom fields' do
